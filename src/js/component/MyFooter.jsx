  ...
  <footer class="footer py-2 my-2">
    ...
    <ul class="nav justify-content-center border-bottom pb-2 mb-2">
      <li class="nav-item d-inline"><a href="https://www.linkedin.com/in/yuliya-bundur/" class="nav-link px-2 text-white">Yuliya Bundur<a href="https://github.com/yuliyabundur" target="_blank" rel="noopener noreferrer">
        <img class="github-logo" src="GitHub-Logo.png" alt="GitHub" className="github-logo" />
      </a></a>
      </li> 
      ...
      <li class="nav-item">
        ...
        <img class="github-logo" src="GitHub-Logo.png" alt="GitHub" className="github-logo" /></a>
        </a>
      </li>
